...
for message in messages:
	...
	annResult = annotator.annotator(message, '../annotator_pkg/lang_data/defeatVirus_nodes.json')
	...
	while choice == 'n' or choice == 't':
		...
		if choice == 'n':
			print('\n')
			annInput = queryForNode('../annotator_pkg/lang_data/defeatVirus_nodes.json', '../annotator_pkg/lang_data/defeatVirus_ann_scheme.json')
			writeToNodeFile(annInput, '../annotator_pkg/lang_data/defeatVirus_nodes.json')
			annStringToDisplay = annotator.annotator(message, '../annotator_pkg/lang_data/defeatVirus_nodes.json')[1]
